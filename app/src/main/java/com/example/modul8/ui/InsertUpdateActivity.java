...
import com.example.modul8.databinding.ActivityInsertUpdateBinding;
import com.example.modul8.helper.DateHelper;
import com.example.modul8.helper.ViewModelFactory;
...
public class InsertUpdateActivity extends AppCompatActivity {
    ...
    private void showAlertDialog(int type) {
        ...
        dialogTitle = isDialogClose ? getString(R.string.cancel) : getString(R.string.cancel);
